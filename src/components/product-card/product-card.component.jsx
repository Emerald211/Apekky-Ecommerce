...
const ProductCard = ({ products }) => {
  ...
  return (
   ...
   <BsCurrencyEuro />{price}
            ...
            <a
              href="#"
              className="text-white bg-main hover:bg-black font-serrat focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-[5px] md:text-sm px-1 md:px-5 py-2.5 text-center "
